...
# CONFIG
# -----------------------------
MODEL_NAME = "RA-ALTA/fr-en-beginner"
MAX_LENGTH = 512
IGNORE_INDEX = -100
HF_REPO = "RA-ALTA/fr-en-beginner-alpaca-english-L1"
...
alpaca_french_small = alpaca_french.select(range(target_size))

print(len(alpaca_english_small))
print(len(alpaca_french_small))
...
dataset = concatenate_datasets([alpaca_english_small, alpaca_french_small])

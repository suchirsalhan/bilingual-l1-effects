...
# CONFIG
# -----------------------------
MODEL_NAME = "RA-ALTA/de-en-intermediate"
MAX_LENGTH = 512
IGNORE_INDEX = -100
HF_REPO = "RA-ALTA/de-en-intermediate-alpaca-english-L1"
...
alpaca_german_small = alpaca_german.select(range(target_size))

print(len(alpaca_english_small))
print(len(alpaca_german_small))
...
dataset = concatenate_datasets([alpaca_english_small, alpaca_german_small])
